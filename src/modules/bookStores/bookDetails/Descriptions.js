  ...
  return (
    <div className="space-y-6">
      <p className="text-[#101B24CC] leading-relaxed">
        Tired of feeling busy but never truly productive? This book is your
        guide to cutting through the noise, setting meaningful goals, and taking
        focused action. Packed with science backed strategies time-tested
        habits, and real-world examples,
      </p>
